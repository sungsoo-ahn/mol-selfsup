...
from module.mol_encoder import AtomEncoder, BondEncoder
...
class GNN_node(torch.nn.Module):
    ...
    def __init__(
        self, num_layer=5, emb_dim=300, drop_ratio=0.5, JK="last", residual=False, gnn_type="gin"
    ):
        """
            emb_dim (int): node embedding dimensionality
    ...
    def forward_with_elems(self, x, edge_index, edge_attr):
